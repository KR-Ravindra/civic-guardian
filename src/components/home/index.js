    ...
    return (
      <SafeAreaView style={styles.container}>
        <View style={styles.header}>
          ...
          <TouchableOpacity onPress={this.toggleModal} style={styles.scholarIcon}>
            <Text style={styles.scholarIconText}>🎓 LEARN</Text>
          </TouchableOpacity>
        </View>
...
const styles = StyleSheet.create({
  ...
  // Add more styles for the rest of your content
});
